...
from medical_seg.networks.layers.factories import Conv, Pad, Pool
from medical_seg.networks.utils import icnr_init, pixelshuffle
from medical_seg.utils import InterpolateMode, UpsampleMode, ensure_tuple_rep
...
class UpSample(nn.Sequential):
    ...
    def  __init__(
        ...
        scale_factor: Union[Sequence[float], float] = (2, 2, 2),
