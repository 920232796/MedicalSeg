...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, model_name='vit_large_patch16_384', img_size=384, patch_size=16, in_chans=3, embed_dim=1024,
                 depth=24,
                 num_heads=16, num_classes=0, mlp_ratio=4., qkv_bias=True, qk_scale=None, drop_rate=0.1,
                 attn_drop_rate=0.,
                 drop_path_rate=0., hybrid_backbone=None, norm_layer=partial(nn.LayerNorm, eps=1e-6), norm_cfg=None,
                 pos_embed_interp=False, random_init=False, align_corners=False, model_path="", **kwargs):
    ...
    def init_weights(self, pretrained=None):
        ...
        if self.random_init == False:
            ...
            if self.model_path != "":
                self.default_cfg["pretrained_finetune"] = self.model_path
